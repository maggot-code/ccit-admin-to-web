<template>
  <div id="tags-view-container" class="tags-view-container">
    <el-link
      ...
      class="el-tabs__nav-prev el-tabs__btn"
      :underline="false"
      @click="prevBtn"
    />
    <el-link
      icon="icon-ym icon-ym-nav-next"
      class="el-tabs__nav-next el-tabs__btn"
      :underline="false"
      @click="nextBtn"
    />
    <scroll-pane
      ...
      >
        ...
        <template v-else>
          <i
            :class="tag.meta.icon"
            class="tag-icon"
            v-if="tag.meta && tag.meta.icon && tagsIcon === '1'"
          ></i
          ><span>{{ generateTitle(tag.meta.title, tag.meta.zhTitle) }}</span>
        </template>
        <span
          v-if="!isAffix(tag)"
          class="el-icon-close"
...
export default {
  ...
  methods: {
    ...
    addTags() {
      if (this.$route.name === "system-sysConfig") {
