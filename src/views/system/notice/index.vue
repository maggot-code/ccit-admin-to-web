<template>
  <div class="CCIT-common-layout">
      ...
      <div class="CCIT-common-layout-main CCIT-flex-main">
        ...
        <CCIT-table v-loading="listLoading" :data="list" max-height="100%">
          <el-table-column prop="title" label="标题" show-overflow-tooltip
            v-if="ccit.hasP('title')" />
          <el-table-column prop="creatorUser" label="发布人员" width="120"
            v-if="ccit.hasP('creatorUser')" />
          <el-table-column prop="publishTime" label="发布时间" :formatter="ccit.tableDateFormat"
            width="120" v-if="ccit.hasP('publishTime')" />
          <el-table-column label="状态" width="100" v-if="ccit.hasP('enabledMark')">
    ...
    <Form v-if="formVisible" ref="Form" @close="formVisible=false" @refreshDataList="initData" />
