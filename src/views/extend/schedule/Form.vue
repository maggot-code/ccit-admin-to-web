<template>
  <el-dialog class="CCIT-dialog CCIT-dialog_center" :title="!dataForm.id ? '添加日程' : '编辑日程'"
  :close-on-click-modal="false" :visible.sync="visible" lock-scroll width="600px" :append-to-body="true">
