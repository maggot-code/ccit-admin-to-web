  ...
  <div class="CCIT-common-layout">
    <div class="CCIT-common-layout-center">
      ...
      <div class="CCIT-common-layout-main CCIT-flex-main">
        ...
        <CCIT-table v-loading="listLoading" :data="list" :columnData="columnList">
        ...
        <CCIT-Form v-if="formVisible" ref="CCITForm" @refreshDataList="initData" />
      </div>
    </div>
  </div>
</template>
...
import CCITForm from '../commonForm'
export default {
  ...
  methods: {
    ...
    addOrUpdateHandle(id) {
      ...
      this.$nextTick(() => {
        this.$refs.CCITForm.init(this.industryTypeList, id)
      })
    }
  }
}
