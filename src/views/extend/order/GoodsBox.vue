<template>
  <el-dialog title="选择商品" :close-on-click-modal="false" :visible.sync="visible"
    class="CCIT-dialog CCIT-dialog_center" lock-scroll append-to-body width="700px">
    ...
    <CCIT-table v-loading="listLoading" :data="list" hasC @selection-change="handleSelectionChange"
      :border="false">
