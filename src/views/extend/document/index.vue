<template>
  <div class="app-container Document-container nohead">
    <el-tabs tab-position="left" style="height:100%" v-model="activeTab">
      <el-tab-pane name="allPanel">
        ...
        <div class="main CCIT-flex-main">
          ...
          <CCIT-table v-loading="listLoading" :data="list" empty-text="该文件夹为空" size="mini">
            ...
            <el-table-column prop="creatorTime" label="创建日期" :formatter="ccit.tableDateFormat"
              width="120" />
            <el-table-column label="操作" fixed="right" width="150">
              <template slot-scope="scope">
                <el-button size="mini" type="text" @click="handleDownLoad(scope.row.id)"
                  :disabled="!scope.row.type">下载</el-button>
                <el-button size="mini" type="text" class="CCIT-table-delBtn"
                ...
                <el-dropdown>
                  ...
                  <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item @click.native="Preview(scope.row.id)"
                                      v-if="scope.row.type">
                      预览
                    </el-dropdown-item>
      ...
      <el-tab-pane name="shareoutPanel">
        ...
        <div class="main CCIT-flex-main">
          ...
          <CCIT-table v-loading="listLoading" :data="list" empty-text="该文件夹为空" size="mini">
            ...
            <el-table-column prop="shareTime" label="共享日期" :formatter="ccit.tableDateFormat"
              width="120" />
            <el-table-column label="操作" fixed="right" width="150">
              <template slot-scope="scope">
                <el-button size="mini" type="text" @click.native="Preview(scope.row.id)"v-if="scope.row.type">预览</el-button>
                <el-button size="mini" type="text" class="CCIT-table-delBtn"
        ...
        <div class="main CCIT-flex-main">
          ...
          <CCIT-table v-loading="listLoading" :data="list" empty-text="该文件夹为空" size="mini">
            ...
            <el-table-column label="操作" fixed="right" width="120">
              <template slot-scope="scope">
                <el-button size="mini" type="text" @click="Preview(scope.row.id)">预览</el-button>
      ...
      <el-tab-pane name="trashPanel">
        ...
        <div class="main CCIT-flex-main">
          ...
          <CCIT-table v-loading="listLoading" :data="list" empty-text="该文件夹为空" size="mini">
            ...
            <el-table-column prop="deleteTime" label="删除日期" :formatter="ccit.tableDateFormat"
              width="120" />
    ...
    <!-- <UserBox v-if="userBoxVisible" type="document" ref="userBox" @refresh="initData" /> -->
...
<script>
import { AllList, Create, Delete, Download, Preview, DocumentInfo, ShareCancel, ShareOutList, ShareTomeList, TrashDelete, TrashList, TrashRecovery, Update } from '@/api/extend/document'
