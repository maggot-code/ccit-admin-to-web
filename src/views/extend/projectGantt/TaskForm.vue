<template>
  <div>
    <el-dialog :title="!dataForm.id ? '新建任务' : '编辑任务'" :close-on-click-modal="false"
      :visible.sync="visible" class="CCIT-dialog CCIT-dialog_center" lock-scrol append-to-body
      width="600px">
      <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="100px">
        <el-form-item label="上级任务" prop="parentId">
          <CCIT-TreeSelect :options="taskTreeData" v-model="dataForm.parentId" placeholder="选择上级任务">
          </CCIT-TreeSelect>
        </el-form-item>
        ...
        <el-form-item label="任务描述" prop="description">
          <el-input v-model="dataForm.description" placeholder="项目描述" type="textarea" :rows="4" maxlength="150" show-word-limit />
        </el-form-item>
      </el-form>
