<template>
  <transition name="el-zoom-in-center">
    <div class="CCIT-preview-main order-form">
      ...
      <div class="main">
        <el-row class="CCIT-common-search-box" :gutter="20">
        ...
        <CCIT-table v-loading="listLoading" :data="list" row-key="id" :hasNO="false"
...
const { v4: uuidv4 } = require('uuid');// 导入uuid生成插件
