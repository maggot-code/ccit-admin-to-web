<template>
  <div class="CCIT-common-layout MessageRecord-container">
    <div class="CCIT-common-layout-center">
      ...
      <div class="CCIT-common-layout-main CCIT-flex-main">
        <el-tabs type="border-card" v-model="activeName" class="messageRecord-tab">
          ...
          <el-tab-pane label="邮件" name="3"></el-tab-pane>
          <el-tab-pane label="外部" name="-1"></el-tab-pane>
          <div class="box">
            ...
            <CCIT-table v-loading="listLoading" :data="list" hasC
              ...
              <el-table-column prop="lastModifyTime" label="发送时间" :formatter="ccit.tableDateFormat"
                width="120" />
