...
export default {
  ...
  computed: {
    creatorTime() {
      return this.ccit.toDate(this.form.creatorTime)
    },
    entryDate() {
      return this.ccit.toDate(this.form.entryDate)
    },
    prevLogTime() {
      return this.ccit.toDate(this.form.prevLogTime)
    },
  },
  created() {
    this.getOptions()
