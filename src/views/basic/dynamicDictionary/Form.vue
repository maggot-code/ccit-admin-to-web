  ...
  <el-dialog :title="!dataForm.id ? '新建字典' : '编辑字典'" :close-on-click-modal="false"
    ...
    <el-form ref="dataForm" :model="dataForm" :rules="dataRule" v-loading="formLoading"
      ...
      <el-form-item label="项目上级" prop="parentId">
        <CCIT-TreeSelect v-model="dataForm.parentId" :options="treeData" placeholder="选择项目上级"
      ...
      <el-form-item label="字典说明" prop="description">
        <el-input v-model="dataForm.description" type="textarea" :rows="6" maxlength="150" show-word-limit />
      </el-form-item>
    </el-form>
