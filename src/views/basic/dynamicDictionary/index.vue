  ...
  <div class="CCIT-common-layout">
    <div class="CCIT-common-layout-center">
      ...
      <div class="CCIT-common-layout-main CCIT-flex-main">
        ...
        <CCIT-table v-loading="listLoading" :data="tableData" row-key="id" default-expand-all
...
export default {
  ...
  methods: {
    ...
    handleUpdateState(row) {
      if (!this.ccit.hasBtnP('btn_edit')) return this.$message.warning(this.$t('common.noPerTip'))
