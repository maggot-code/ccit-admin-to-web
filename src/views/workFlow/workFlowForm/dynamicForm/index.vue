...
export default {
  ...
  methods: {
    init(data) {
      this.setting = data
      //替换当前人、当前部门、当前组织
      let formConf = data.formConf ? data.formConf.replaceAll('{this.$store.getters.userInfo.userName}', this.$store.getters.userInfo.userName)
      ...
      this.formConf = formConf ? JSON.parse(formConf) : {}
