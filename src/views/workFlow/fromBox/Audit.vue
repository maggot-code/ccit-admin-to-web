  ...
  <transition name="el-zoom-in-center">
    <div class="CCIT-preview-main flow-form-main nohead">
      ...
      <el-dialog title="审批通过" :close-on-click-modal="false" :visible.sync="visible"
        class="CCIT-dialog CCIT-dialog_center" lock-scroll append-to-body width='450px'>
        <el-radio-group v-model="handleType" @change="radioChange">
          ...
          <el-radio :label="0" class="radio-audit">
            <User-TreeSelect v-model="handleId" placeholder="选择下一审批人" :disabled="handleType!=0"></User-TreeSelect>
          </el-radio>
        </el-radio-group>
