...
const layouts = {
  ...
  rowFormItem(h, element, index, parent) {
    ...
    if (element.__config__.ccitKey === 'row') {
    ...
    if (element.__config__.ccitKey === 'card') {
      let tip = ''
      if (!element.__config__.children.length) {
        tip = <div class="table-tip">请将组件拖到此区域(可拖多个组件)</div>
      }
    ...
    if (element.__config__.ccitKey === 'table') {
      let tip = ''
      if (!element.__config__.children.length) {
        tip = <div class="table-tip">请将组件拖到此区域(可拖多个组件)</div>
      }
