        ...
        <el-form v-show="currentTab === 'field' && showField" size="small" label-width="90px"
          ...
          <template v-if="activeData.__config__">
            ...
            <el-form-item label="标题名"
              v-if="activeData.__config__.label !== undefined && !['CCITText','card','groupTitle'].includes(activeData.__config__.ccitKey)">
            ...
            <template v-if="activeData.__config__.ccitKey === 'comInput'">
            ...
            <template
              v-if="activeData.__config__.ccitKey === 'numInput' ||activeData.__config__.ccitKey === 'slider'">
            ...
            <template
              v-if="['radio', 'checkbox', 'select'].indexOf(activeData.__config__.ccitKey) > -1">
              ...
              <template v-if="activeData.__config__.dataType === 'dynamic'">
                <el-form-item label="数据接口">
                  <CCIT-TreeSelect :options="dataInterfaceSelector"
            ...
            <template
              v-if="activeData.__config__.ccitKey === 'treeSelect' || activeData.__config__.ccitKey === 'cascader'">
              <el-form-item label="" label-width="40px">
                <el-radio-group v-model="activeData.__config__.dataType" size="small"
                  style="text-align:center" @change="dataTypeChange">
                  <el-radio-button label="static">静态数据</el-radio-button>
            ...
            <template v-if="activeData.__config__.ccitKey === 'CCITText'">
            ...
            <template v-if="activeData.__config__.ccitKey === 'groupTitle'">
...
export default {
  ...
  methods: {
    ...
    dataTypeChange(val) {
      ...
      if (this.activeData.__config__.ccitKey === 'treeSelect' || this.activeData.__config__.ccitKey === 'cascader') {
