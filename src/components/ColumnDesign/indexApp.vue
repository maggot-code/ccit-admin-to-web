  ...
  <div class="columnDesign-container">
    <div class="main-board">
      <div class="sort-box">
        ...
        <el-table :data="columnData.sortList" class="CCIT-common-table" ref="dragTableSort"
      ...
      <div class="search-box">
        ...
        <el-table :data="columnData.searchList" class="CCIT-common-table" ref="dragTableSearch"
          :row-key="row=>row.prop">
          <el-table-column align="center" label="拖动" width="50">
            <template>
              <i class="drag-handler icon-ym icon-ym-darg" style="cursor: move;font-size:20px"
      ...
      <div class="column-box">
        ...
        <el-table :data="columnData.columnList" class="CCIT-common-table" ref="dragTable"
          :row-key="row=>row.prop">
          <el-table-column align="center" label="拖动" width="50">
            <template>
              <i class="drag-handler icon-ym icon-ym-darg" style="cursor: move;font-size:20px"
    ...
    <el-scrollbar class="right-board">
      ...
      <div class="field-box">
        <div v-show="currentTab==='sort'">
          <el-table :data="sortOptions" class="CCIT-common-table"
        ...
        <div v-show="currentTab==='search'">
          <el-table :data="searchOptions" class="CCIT-common-table"
        ...
        <div class="columnList" v-show="currentTab==='field'">
          <el-table :data="columnOptions" class="CCIT-common-table"
...
export default {
  ...
  created() {
    ...
    const loop = (data, parent) => {
      if (!data) return
      if (data.__config__ && data.__config__.ccitKey !== 'table' && data.__config__.children && Array.isArray(data.__config__.children)) {
    ...
    loop(getDrawingList())
    this.list = list
    let options = list.filter(o => noColumnShowList.indexOf(o.__config__.ccitKey) < 0)
