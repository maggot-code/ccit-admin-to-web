        ...
        <div class="toDolistMain">
            ...
            <div class="listContent">
                <el-tabs v-model="activeName" @tab-click="handleClick">
                    ...
                    <el-tab-pane :label="nomalList" name="yixue">
                    ...
                    <el-tab-pane :label="saveList" name="save3">
                                ...
                                toBeLearn(
                                    {
                                        ...
                                        (res) => {
                                            if (res.code == 200) {
                                                ...
                                                document.getElementById("tab-daixue").innerHTML = `待学(<span style="color:red">${res.data.tasks.length}</span>)`
                                            }
                                        }
                                    )
                                toBeLearn(
