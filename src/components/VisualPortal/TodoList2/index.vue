<template>
    <el-card :class="['portal-box', titleColor]" :style="cardStyle">
        <div :slot="headerSlot" class="portal-common-title" :style="titleStyle">
            ...
            <div class="checList">
                <div class="OAclass" @click="filterData('oaid')">OA</div>
                <div class="ITclass" @click="filterData('itzhid')">IT</div>
                <div class="ERPclass" @click="filterData('erpid')">ERP</div>
                <div class="dianshangclass" @click="filterData('pecid')">电商</div>
                <div class="falvclass" @click="filterData('flswid')">法律</div>
                <div class="kechuangclass" @click="filterData('kjcx')">科创</div>
                <div class="kehuclass" @click="filterData('crmid')">客户</div>
                <div class="waishiclass" @click="filterData('famsid')">外事</div>
                <div class="xuexiclass" @click="filterData('xuexi')">学习</div>
            </div>
            <div class="right">
