<template>
    <div :class="['portal-box', titleColor]" :style="cardStyle" v-loading="loading">
        <div class="boxparent">
            <div class="boxtitle">
                中煤要闻&nbsp;丨
            </div>
            <div class="box topline">
                <div class="txt">
                    <a href="http://172.16.0.83/web974758/subject/n1/n974758/n974770/n974869/c2099487/content.html" target="_blank">中煤集团虎年首月开门红&nbsp;&nbsp;&nbsp;&nbsp;丨&nbsp;&nbsp;&nbsp;&nbsp;</a>
                    <a href="http://172.16.0.83/web974758/subject/n1/n974758/n974770/n974869/c2099450/content.html" target="_blank">虎力全开！中煤集团春节假期能源保供再创新高！&nbsp;&nbsp;&nbsp;&nbsp;丨&nbsp;&nbsp;&nbsp;&nbsp;</a>
                    <a href="http://172.16.0.83/web974758/subject/n1/n974758/n974770/n974869/c2099216/content.html" target="_blank">彭毅看望慰问节日期间值班值守人员&nbsp;&nbsp;&nbsp;&nbsp;丨&nbsp;&nbsp;&nbsp;&nbsp;</a>
                    <a href="http://172.16.0.83/web974758/subject/n1/n974758/n974770/n974869/c2098813/content.html" target="_blank">集团公司召开新春团拜会&nbsp;&nbsp;&nbsp;&nbsp;丨&nbsp;&nbsp;&nbsp;&nbsp;</a>
                    <a href="http://172.16.0.83/web974758/subject/n1/n974758/n974770/n974869/c2097605/content.html" target="_blank">中煤集团董事会召开2022年第二次会议&nbsp;&nbsp;&nbsp;&nbsp;丨&nbsp;&nbsp;&nbsp;&nbsp;</a>
                    <a href="http://172.16.0.83/web974758/subject/n1/n974758/n974770/n974869/c2097593/content.html" target="_blank">集团公司获“2021年度中央企业考核分配工作先进单位”荣誉称号&nbsp;&nbsp;&nbsp;&nbsp;丨&nbsp;&nbsp;&nbsp;&nbsp;</a>
                    <a href="http://172.16.0.83/web974758/subject/n1/n974758/n974770/n974869/c2097536/content.html" target="_blank">中煤集团2022新春致辞&nbsp;&nbsp;&nbsp;&nbsp;丨&nbsp;&nbsp;&nbsp;&nbsp;</a>
        ...
        <div class="portal-boxokkok">
            <div :slot="headerSlot" class="portal-common-title" :style="titleStyle">
                ...
                <div class="checList">
                    <div class="OAhover" :class="panduanstate=='oaid'?'OAclassBG':'nanalbg'" @click="filterData('oaid')">OA</div>
                    <div class="ERPhover" :class="panduanstate=='erpid'?'ERPclassBG':'nanalbg'" @click="filterData('erpid')">ERP</div>
                    <div class="falvhover" :class="panduanstate=='flswid'?'falvclassBG':'nanalbg'" @click="filterData('flswid')">法律</div>
                    <div class="IThover" :class="panduanstate=='itzhid'?'ITclassBG':'nanalbg'" @click="filterData('itzhid')">IT</div>
                    <div class="dianshanghover" :class="panduanstate=='pecid'?'dianshangclassBG':'nanalbg'" @click="filterData('pecid')">电商</div>
                    <div class="kechuanghover" :class="panduanstate=='kjcx'?'kechuangclassBG':'nanalbg'" @click="filterData('kjcx')">科创</div>
                    <div class="kehuhover" :class="panduanstate=='crmid'?'kehuclassBG':'nanalbg'" @click="filterData('crmid')">客户</div>
                    <div class="waishihover" :class="panduanstate=='famsid'?'waishiclassBG':'nanalbg'" @click="filterData('famsid')">外事</div>
                    <div class="xuexihover" :class="panduanstate=='xuexi'?'xuexiclassBG':'nanalbg'" @click="filterData('xuexi')">学习</div>
                </div>
                <div class="right">
                    <span v-if="item.showFresh" title="刷新" class="item">
                        <span style="color:#72A5DA;font-size:14px;font-weight:500;cursor: pointer;" @click="getData(panduanstate)">刷新</span>
                    </span>
                    <span v-if="item.showMore" title="更多" class="item">
                        <span style="color:#72A5DA;font-size:14px;font-weight:500;cursor: pointer;" @click="jumpToMore">更多</span>
                    </span>
                </div>
            </div>

            <div class="portal-box-body todolist" :style="bodyStyle">
...
export default {
    ...
    mounted() {
        ...
        this.filterData(this.panduanstate);
...
.nanalbg {
    background: url("./images/nalmal.png") no-repeat;
    color: #333333;
    font-weight: 500;
}
// 按钮的hover效果
