<template>
    <el-card :class="['portal-box', titleColor]" :style="cardStyle">
        ...
        <div class="allcheck" ref="allcheck" @click="toggleSelection(toDoList.data)"  v-show="toDoList.data && toDoList.data.length>1">全选</div>
        <div class="allread" ref='allread' @click="toggleSelectionChecked(toDoList.data)" v-show="multipleSelection.length>0">已读</div>
        <div class="sendMailperson" v-show="toDoList.data && toDoList.data.length>0">发件人</div>
                    ...
                    <el-tab-pane :label="'邮件(0)'" name="youjian">
                        <div v-if='toDoList.data && toDoList.data.length!=0'>
                            ...
                            <el-table ref="multipleTable" :data="toDoList.data" tooltip-effect="dark" style="width: 100%" :show-header="false" @selection-change="handleSelectionChange">
                                ...
                                <el-table-column label="姓名" width="30px">
                                    <template slot-scope="scope">
                                ...
                                <el-table-column label="姓名" width="103px">
                                    <template slot-scope="scope">
